...
if ($option == 'banner') {
    ...
    $output_panel.= '<tr><td class="text_right">Size:</td><td class="text_left orange">W <input class="ban" type="text" name="banner[]" value="' . $b[27] . '"> H <input class="ban" type="text" name="banner[]" value="' . $b[28] . '"></td></tr>';
